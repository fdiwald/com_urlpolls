CREATE TABLE IF NOT EXISTS `#__urlpolls_person` (
...
CREATE TABLE IF NOT EXISTS `#__urlpolls_poll` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
	`asset_id` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
CREATE TABLE IF NOT EXISTS `#__urlpolls_recipient` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
	`asset_id` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
